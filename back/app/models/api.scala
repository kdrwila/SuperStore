...
case class BasketProductsREST(id: Long, user_id: Long, quantity: Long, product_id: Long)
case class BasketProductsPOST(user_id: Long, quantity: Long, product_id: Long)
